...
public class ModelEnergia {
    ...
    public void CalcularICMS (double consumo, double fornecimento) {
        if (consumo <= 200) {
            ...
            this.setIcms(fornecimento * 0.3333333);
        }
    }
    ...
    public void CalcularPisPasep (double consumo, double fornecimento) {
        if (consumo <= 200) {
            ...
            this.setPispasep(fornecimento * 0.0158641);
        }
    }
    ...
    public void CalcularFatura(double fornecimento, double icms, double cofins, double pispasep, double icmscofins, double icmspispasep) {
